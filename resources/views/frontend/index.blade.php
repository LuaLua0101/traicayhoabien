        ...
        <div id="wowslider-container1">
            <div class="ws_images">
                <ul>
                    ...
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/cara-muslim_konsumsi-buah-yang-tepat-1549.jpg')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/fruit-tong-hop-1-5827.jpg')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/tao-3684.jpg')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/frutta-7815.jpg')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/untitled-1-copy-2838.jpg')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/untitled-1-5597.jpg')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{asset('public/thumb/1366x490x1x100/upload/hinhanh/sl-3724.png')}}" alt="https://traicayhoabien.com/" title="" />
                        </a>
                    </li>
                </ul>
            </div>
